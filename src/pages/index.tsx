    ...
    <div className='flex flex-col items-center justify-center min-h-screen h-auto w-screen gap-8 lg:py-6'>
      ...
      <div className="w-full flex flex-col gap-2 items-center justify-center max-w-6xl mx-auto p-4">
        <div className="w-full flex flex-col lg:flex-row gap-3 items-center justify-center text-center">
          <p className="text-sm opacity-60 max-w-xs lg:max-w-none">Rust Trade Evaluator is open-source, <a className="text-crimson hover:underline" href="https://github.com/jimmybisenius/trade-rust" target="_blank">view our source-code on Github.</a></p>
        ...
        <p className="text-xs opacity-30 mx-auto text-center">This site is is not officially affiliated with, endorsed by, or connected to the makers of &quot;Rust&quot; (Facepunch Studios).</p>
      </div>
    </div>
  )
}
